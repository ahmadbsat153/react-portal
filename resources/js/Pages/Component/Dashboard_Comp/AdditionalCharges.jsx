...
export default function AdditionalCharges({
    ...
    const [report, setReport] = useState(AdditionalData);
    ...
    const filterData = (startDate, endDate, selectedConsignment) => {
        ...
        const filtered = AdditionalData?.filter((item) => {
                                    ...
                                    <table className="min-w-full table-fixed divide-y divide-gray-300">
                                        <thead>
                                            <tr className="py-2.5">
                                                ...
                                                <th
                                                    scope="col"
                                                    className="min-w-[8rem] py-4 pr-3 text-left text-sm font-semibold text-gray-900"
                                                >
                                                    Con No.
                                                </th>
                                                <th
