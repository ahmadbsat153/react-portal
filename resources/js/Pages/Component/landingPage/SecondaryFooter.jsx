...
const navigation = {
    ...
    support: [
        ...
        { name: "Client login", href: "https://jaixwebapps.gtls.com.au/Portal/Account/Login.aspx" },
...
export default function SecondaryFooter() {
    return (
        <footer className="bg-black" aria-labelledby="footer-heading" id="footer">
                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div className="mt-16 grid grid-cols-1 gap-8 xl:col-span-2 xl:mt-0">
                        <div className="md:grid md:grid-cols-3 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold leading-6 text-goldt">
                                    Web Navigation
                                </h3>
